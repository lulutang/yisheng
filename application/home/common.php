 ...
 * @param string $type
 * @param array $data
 * @param bool $status  Ps 如果用get 传参 true $data为字符串 false为array 默认 falsa
 * @return array|boolean
 */
function curlData($url, $type = 'GET', $data = array(),$status=false){
    $ch = curl_init();
    if(empty($url) || ! $ch)    return false;
